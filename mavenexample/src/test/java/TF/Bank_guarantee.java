...
public class Bank_guarantee {
    ...
    void setUp() throws Exception {
        ...
        //Выбираем сертификат(Подписант ВТБ)

        driver.findElement(By.xpath("//*[@id=\"__BVID__34___BV_modal_body_\"]/div[2]/select/option[4]")).click();
        ...
        t = (new WebDriverWait(driver, 60)).
                ...
                // Зайти в гарантию в статусе "На подпись"
