    ...
    ((JavascriptExecutor) driver).executeScript("arguments[0].click()", t);*/
       ...
       // driver.findElement(By.cssSelector("//*[@id=\"app\"]/div[2]/div[1]/div/ul/li[11]/a")).click();//*[@id="app"]/div[2]/div[1]/div/ul/li[11]/a/p //*[@id="app"]/div[2]/div[1]/div/ul/li[15]/a/p
        ...
        //Перейти в требование в статусе получено                           //*[@id="__BVID__223"]/tbody/tr[6]/td[4] //*[@id="__BVID__298"]/tbody/tr[6]/td[5]
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__223\"]/tbody/tr[6]/td[5]"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //Решение по требованию
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/form/div[34]/button[4]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //Подписать
        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/form/div[12]/button[5]"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].click()", t);
        t = (new WebDriverWait(driver, 15)).
        //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/form/div[12]/button[5]


        //Подтвердить действие
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__324___BV_modal_footer_\"]/div/button[2]"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
