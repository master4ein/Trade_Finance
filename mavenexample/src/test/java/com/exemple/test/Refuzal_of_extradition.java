...
class Refuzal_of_extradition {
    ...
    void setUp() throws Exception {
        ...
        //Перейти в гарантию //*[@id="__BVID__209"]/tbody/tr[16]/td[9] //*[@id="__BVID__582"]/tbody/tr[17]/td[9]//*[@id="__BVID__582"]/tbody/tr[17]/td[9]
        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__209\"]/tbody/tr[17]/td[9]"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //Отказать в выдаче/изменение условий гарантии
        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[10]/button[2]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //Указать причину
        WebElement
                element = driver.findElement(By.xpath("//*[@id=\"__BVID__325\"]"));
        element.sendKeys("ТЕСТ_Отказ");
        t = (new WebDriverWait(driver, 5)).

        //Отказать
        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__323___BV_modal_footer_\"]/div/button[2]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //*[@id="__BVID__352___BV_modal_footer_"]/div/button[2]/span
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__352___BV_modal_footer_\"]/div/button[2]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].click()", t);
        Thread.sleep(30000);
        //*[@id="__BVID__323___BV_modal_footer_"]/div/button[2]/span
