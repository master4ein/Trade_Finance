...
class Warranty_Publication {
    ...
    void setUp() throws Exception {
        ...
        t = (new WebDriverWait(driver, 5)).
                ...
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[1]/div/ul/li[7]/a/p"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        t = (new WebDriverWait(driver, 20)).
                ...
                //Обновить список
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/button/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        t = (new WebDriverWait(driver, 20)).
                ...
                //Перейти в гарантию                                                //*[@id="__BVID__235"]/tbody/tr[3]/td[11] //*[@id="__BVID__543"]/tbody/tr[4]/td[11] //*[@id="__BVID__543"]/tbody/tr[5]/td[11]
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__235\"]/tbody/tr[4]/td[11]"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        //Опубликовать
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[6]/button[3]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        //t.click();
        ((JavascriptExecutor) driver).executeScript("arguments[0].click()", t);
        t = (new WebDriverWait(driver, 5)). //*[@id="__BVID__298___BV_modal_footer_"]/div/button[2]/span/svg/path

        //Подтвердить действие
                until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__298___BV_modal_footer_\"]/div/button[2]/span"))); //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[1]/button/span
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].click()", t);
        Thread.sleep(30000);
        //*[@id="__BVID__298___BV_modal_footer_"]/div/button[2]/span/svg/path

        //*[@id="app"]/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[6]/button[3]/span
//*[@id="app"]/div[2]/div[1]/div/ul/li[7]/a/p
