...
//Создание и отправка ЦБГ в банк
...
class SignAndSend {
    ...
    void setUp() throws Exception {
      ...
      //Подать заявление
        ...
        element.sendKeys("17122019"); //Сделать дата = тек.дата
        ...
        t = (new WebDriverWait(driver, 1)).
                ...
                //Подтвердить действие
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__BVID__732___BV_modal_footer_\"]/div/button[2]/span")));
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        ////*[@id="__BVID__732___BV_modal_footer_"]/div/button[2]/span
