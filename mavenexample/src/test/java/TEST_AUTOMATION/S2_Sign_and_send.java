...
public class S2_Sign_and_send {
    ...
    void setUp() throws Exception {
        ...
        //Выбрать роль "Подписант Крипто-про"

        WebElement element;
        element = driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div/div[1]/div/div/div/div[2]/select/option[2]"));
        element.click();
        ...
        t = (new WebDriverWait(driver, 300)).
                ...
                //Перейти в заявление в статусе "На подпись"
