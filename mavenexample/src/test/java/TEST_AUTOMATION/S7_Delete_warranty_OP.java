...
//Оператор подписант создает гарантию и удаляет
...
public class S7_Delete_warranty_OP {
    ...
    void setUp() throws Exception {
       ...
       // Thread.sleep(30000);
        ...
        until(ExpectedConditions.presenceOfElementLocated(xpath("/html/body/div/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div[3]/div/div[1]/div/div/footer/div/button[2]")));
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
