...
public class S3A_Operator_send_warranty {
    ...
    void setUp() throws Exception {
        ...
        t = (new WebDriverWait(driver, 300)).
                        ...
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div[2]/div[1]/div/ul/li[7]/a")));
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
        ...
        t = (new WebDriverWait(driver, 120)).
                ...
                /*Обновить список гарантий                                         //html/body/div/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/button
                        until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div[2]/div[2]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/button")));
        System.out.println(t);
        System.out.println(t.isEnabled());
        System.out.println(t.isDisplayed());
        System.out.println(t.getText());
